...
namespace ProjetGestionClubGolf.FormsAjoutAbonnement
{
    public partial class AjoutAbonnement3Enfant : Form
    {
        ...
        private void btnEnregistrer_Click(object sender, EventArgs e)
        {
            ...
            DateTime dateNaissanceEnfant3 = dtpDateNaissanceEnfant3.Value.Date;
            ...
            errMessage.SetError(txtNomEnfant3, string.Empty);
            errMessage.SetError(txtPrenomEnfant3, string.Empty);
            errMessage.SetError(dtpDateNaissanceEnfant3, string.Empty);
            ...
            if (string.IsNullOrWhiteSpace(txtNomEnfant3.Text))
            {
                booValide = false;
                errMessage.SetError(txtNomEnfant3, "Le nom de l'enfant 3 ne peut être vide");
            }
            if (string.IsNullOrWhiteSpace(txtPrenomEnfant3.Text))
            {
                booValide = false;
                errMessage.SetError(txtPrenomEnfant3, "Le prénom de l'enfant 3 ne peut être vide");
            }
            ...
            if (dtpDateNaissanceEnfant3.Value == null)
            {
                booValide = false;
                errMessage.SetError(dtpDateNaissanceEnfant3, "SVP sélectionner une date");

            }
            else
            {
                ageEnfant3 = DateTime.Now.Subtract(dateNaissanceEnfant3).Days;
                ageEnfant3 = ageEnfant3 / 365;
                if (ageEnfant3 > 18)
                {
                    booValide = false;
                    errMessage.SetError(dtpDateNaissanceEnfant3, "L'enfant 3 doit avoir moins de 18 ans");
                }
            }
        ...
        private bool AjoutAbonnement(bool booCell)
        {
            ...
            string nomEnfant3 = txtNomEnfant3.Text;
            string prenomEnfant3 = txtPrenomEnfant3.Text;
            DateTime dateNaissanceEnfant3 = dtpDateNaissanceEnfant3.Value.Date;
            string remarqueEnfant3 = txtRemarqueEnfant3.Text;
            string sexeEnfant3 = cboSexeEnfant3.SelectedValue.ToString();
            ...
            string leIdEnfant3 = string.Concat(leId.Substring(0, leId.Length - 1), "E3");
            ...
            try
            {
                ...
                Dependant dependantEnfant3 = new Dependant()
                {
                    Id = leIdEnfant3,
                    Nom = nomEnfant3,
                    Prenom = prenomEnfant3,
                    DateNaissance = dateNaissanceEnfant3,
                    IdAbonnement = leId,
                    Remarque = remarqueEnfant3,
                    Sexe = sexeEnfant3
                };
                monDataContext.Dependants.InsertOnSubmit(dependantEnfant3);
        ...
        private void AjoutListComboBoxSexe()
        {
            ...
            cboSexeEnfant3.DataSource = new BindingSource(comboSource, null);
            cboSexeEnfant3.DisplayMember = "Value";
            cboSexeEnfant3.ValueMember = "Key";
        }

        private void AjoutAbonnement3Enfant_Load(object sender, EventArgs e)
        {
